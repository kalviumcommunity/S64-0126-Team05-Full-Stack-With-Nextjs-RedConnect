        ...
        <div className="flex h-screen bg-gray-50 font-sans text-gray-900 overflow-hidden">
            ...
            <aside className="w-64 bg-white border-r border-gray-100 flex-shrink-0 flex flex-col h-full">
                ...
                <nav className="flex-1 px-4 space-y-1 py-4">
                    <Link href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium bg-red-50 text-red-600 relative">
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-red-600 rounded-r-lg"></div>
                        <LayoutGrid className="w-5 h-5" />
                        Dashboard
                    </Link>
                    <Link href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition">
                ...
                <div className="p-4">
                    <button className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 rounded-xl shadow-lg shadow-red-600/20 flex items-center justify-center gap-2 transition">
                    ...
                    <div className="max-w-7xl mx-auto space-y-8">
                                    ...
                                    <div key={campaign.id} className={`bg-white rounded-2xl p-6 shadow-sm border border-gray-100 relative overflow-hidden ${campaign.status === 'CRITICAL' ? 'border-l-4 border-l-red-600' : 'border-l-4 border-l-orange-400'}`}>
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex -space-x-2">
                                                ...
                                                {campaign.startsIn && (
                                                    <span className="flex items-center gap-1.5 text-xs text-brown-600 font-medium ml-4">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <select className="bg-gray-50 border-none text-xs font-bold text-gray-600 rounded-lg py-1.5 pl-3 pr-8 focus:ring-1 focus:ring-red-200">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div className="w-full h-48 bg-gray-100 rounded-xl relative overflow-hidden">
                                ...
                                />
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 py-2 rounded-lg shadow-md flex items-center gap-2">
