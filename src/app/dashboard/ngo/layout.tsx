...
export default function NGOLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex h-screen bg-gray-50 dark:bg-[#0a0a0f] font-sans text-gray-900 dark:text-gray-100 overflow-hidden">
            {/* ── Sidebar ── */}
            <aside className="w-64 bg-white dark:bg-[#111118] border-r border-gray-100 dark:border-[#1f1f2e] flex-shrink-0 flex flex-col h-full transition-colors">
                <div className="p-6 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="font-bold text-lg text-gray-900 dark:text-white leading-none">RedConnect</h1>
                        <p className="text-xs text-gray-500 dark:text-gray-400">NGO Portal</p>
                    </div>
                </div>
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors relative ${isActive
                                    ? "bg-red-50 dark:bg-red-900/10 text-red-600 dark:text-red-500"
                            ...
                            >
                                ...
                                <Icon className={`w-5 h-5 ${isActive ? "text-red-600 dark:text-red-500" : "text-gray-400 dark:text-gray-500"}`} />
                                {link.label}
                            </Link>
                        );
                    })}
            ...
            {/* ── Main Content ── */}
            <main className="flex-1 flex flex-col h-screen overflow-hidden transition-colors">
                {/* Header */}
                <header className="h-20 bg-white dark:bg-[#111118] border-b border-gray-100 dark:border-[#1f1f2e] flex items-center justify-between px-8 flex-shrink-0 transition-colors">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-3">
                            <button className="p-2.5 rounded-lg bg-gray-50 dark:bg-[#16161f] hover:bg-gray-100 dark:hover:bg-[#1f1f2e] text-gray-600 dark:text-gray-400 transition">
                        ...
                        <div className="w-10 h-10 rounded-full overflow-hidden border border-gray-200 dark:border-gray-800 shadow-sm">
                            <Image
