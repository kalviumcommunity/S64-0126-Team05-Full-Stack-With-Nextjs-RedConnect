                ...
                <div className="bg-white rounded-lg p-6 border border-gray-200">
                    ...
                    <div className="space-y-3">
                        {bloodTypeStats.map((stat) => (
                            <div
                                key={stat.type}
                                className={`p-3 rounded-lg border ${stat.shortage
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    <div>
                                        <p
                                            className={`font-bold ${stat.shortage
                                                    ? "text-red-800"
                                                    : "text-green-800"
                                                }`}
                                        >
                                        ...
                                        <p
                                            className={`text-xs ${stat.shortage
                                                    ? "text-red-700"
                                                    : "text-green-700"
                                                }`}
                                        >
                                    ...
                                    <div className="text-right">
                                        <p
                                            className={`font-bold text-sm ${stat.shortage
                                                    ? "text-red-600"
                                                    : "text-green-600"
                                                }`}
                                        >
